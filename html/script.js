      ...
      .end(function() {
        ...
        typer(content[0])
          ...
          .line([
            ...
            ' _\/\/\"\\\\_<br>',
            '  \/   \\<br><br>',
            "You are now in ","contact with Dark Spider. ","We can wash your ","dirty money for a ","reasonable price. Beware that ","any interruptions during the ","wash process will CANCEL ","the wash and DESTROY ","chunks of your black money.<br><br>",
          ])
  ...
  var Confirm = function(options) {
    ...
    typer(content[0])
      ...
      .line([
        ...
        "90%<br>",
        "95%<br>",
        "Transaction complete. Press <em>ENTER</em> to exit"
